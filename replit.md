...
- **macOS Development**: Requires Node.js v20 LTS (v24 has ENOTSUP socket errors). Server runs on port 5000 (same as production). Database is optional for Simple Player mode - app works completely offline with localStorage.
