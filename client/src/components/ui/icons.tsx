...
// This file contains custom SVG icons used throughout the application
// All icons should be exported with consistent props pattern 
...
export const FavoriteFillIcon: React.FC<IconProps> = ({
  size = 24,
  className = "",
  ...props
}) => (
